  ...
  return (
    <div className="mt-3 rounded-xl border border-cyan-200/70 bg-cyan-50/40 p-3 shadow-sm sm:p-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <p className="inline-flex rounded-full bg-cyan-100 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide text-[#E50046]">
          Comprension oral
        </p>
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="inline-flex min-h-11 items-center justify-center rounded-xl bg-[#E50046] px-3.5 text-sm font-semibold text-white"
            ...
            <button
              ...
              className="inline-flex min-h-11 items-center justify-center rounded-xl border border-cyan-300 bg-white px-3 text-sm font-semibold text-[#E50046]"
          ...
          <input
            ...
            className="w-full accent-[#E50046]"
            disabled={!isReady}
          />
