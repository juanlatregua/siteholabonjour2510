...
import type { FilmQuizQuestion } from "@/data/films/films";
    ...
    return (
      <div className="vie-card rounded-xl p-6 text-center">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Has acertado{" "}
          <span className="font-bold" style={{ color: "var(--vie-bleu)" }}>
            {score}
          </span>{" "}
          de {quiz.length} preguntas sobre{" "}
          <span className="font-semibold">{filmTitle}</span>.
        </p>
        <button
      ...
      {selected !== null && (
        <div className="mt-4 flex justify-end">
          <button
            ...
            style={{ backgroundColor: "var(--vie-bleu)" }}
          >
