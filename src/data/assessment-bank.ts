...
const questionsA1: AssessmentQuestion[] = [
  ...
  makeQuestion(
    "a1-q9",
    "comprension-escrita",
    "Lees esta nota en un comercio: Vendeur/vendeuse. Samedi et dimanche, 10h-18h. Téléphonez au 01 42 36 10 10. Es una oferta de...",
    [
  ...
  makeQuestion(
    "a1-q10",
    "comprension-escrita",
    "En la carta de un cafe: Petit-déjeuner complet 8 EUR. Croissant + cafe 4,50 EUR. Cuanto cuesta el desayuno completo?",
    [
      ["a", "4,50 euros"],
      ["b", "8 euros"],
      ["c", "12,50 euros"],
  ...
  makeQuestion(
    "a1-q14",
    "comprension-escrita",
    "Lees un mensaje: N'oubliez pas demain! Rendez-vous a 9h devant la gare. Apportez votre billet de train. Que debes llevar?",
    [
      ["a", "Tu pasaporte"],
  ...
  makeQuestion(
    "a1-q19",
    "comprension-oral",
    "Escuchas: La boulangerie? Vous allez tout droit, puis vous tournez à gauche. C'est en face de la poste. Donde esta la panaderia?",
    [
...
const DELF_A1_AUDIO = {
  co1: { src: "/delf/a1/co1-audio.mp3", title: "Exercice 1 – Message téléphonique" },
  co2: { src: "/delf/a1/co2-audio.mp3", title: "Exercice 2 – Annonce aéroport" },
...
const delfA1Sections: AssessmentSection[] = [
  {
    ...
    description: "Écoutez les documents audio et répondez aux questions.",
    order: 1,
  },
  {
    id: "comprension-escrita",
    title: "Compréhension des écrits",
    description: "Lisez les documents et répondez aux questions.",
    order: 2,
  },
];
...
const questionsA1Simulacro: AssessmentQuestion[] = [
  ...
  { id: "a1s-co1-q1", sectionId: "comprension-oral", prompt: "Exercice 1 – Votre amie Solange laisse un message sur votre répondeur.\n\nSolange vous invite a...", difficulty: "easy", points: 1, options: [{ id: "a", text: "prendre le petit-déjeuner" }, { id: "b", text: "déjeuner" }, { id: "c", text: "dîner" }], correctOptionId: "b", audio: DELF_A1_AUDIO.co1 },
  ...
  // === CO – EXERCICE 2 (5 pts) – Annonce aéroport ===
  { id: "a1s-co2-q1", sectionId: "comprension-oral", prompt: "Exercice 2 – Vous entendez une annonce dans un aéroport.\n\nQuel est le numéro du vol ?", difficulty: "easy", points: 1, options: [{ id: "a", text: "AF335" }, { id: "b", text: "AR315" }, { id: "c", text: "AS305" }], correctOptionId: "a", audio: DELF_A1_AUDIO.co2 },
  ...
  { id: "a1s-co3-q3", sectionId: "comprension-oral", prompt: "Ou déjeunez-vous ?", difficulty: "medium", points: 2, options: [{ id: "a", text: "Au bureau" }, { id: "b", text: "Au restaurant" }, { id: "c", text: "A la maison" }], correctOptionId: "b", audio: DELF_A1_AUDIO.co3 },
  { id: "a1s-co3-q4", sectionId: "comprension-oral", prompt: "A quelle heure est votre réunion avec l'entreprise Nysol ?", difficulty: "medium", points: 2, options: [{ id: "a", text: "14h" }, { id: "b", text: "15h" }, { id: "c", text: "16h" }], correctOptionId: "b", audio: DELF_A1_AUDIO.co3 },

  // === CO – EXERCICE 4 (10 pts) – Dialogues et images ===
  { id: "a1s-co4-q1", sectionId: "comprension-oral", prompt: "Exercice 4 – Écoutez 5 dialogues et associez chaque dialogue a l'image correspondante.\n\nDialogue 1 correspond a quelle image ?", contextImage: "/delf/a1/co4-grid.png", difficulty: "medium", points: 2, options: [{ id: "a", text: "Image A" }, { id: "b", text: "Image B" }, { id: "c", text: "Image C" }, { id: "d", text: "Image D" }, { id: "e", text: "Image E" }, { id: "f", text: "Image F" }], correctOptionId: "e", audio: DELF_A1_AUDIO.co4 },
  ...
  { id: "a1s-co5-q3", sectionId: "comprension-oral", prompt: "3. Le téléphone portable", difficulty: "easy", points: 1, options: [{ id: "a", text: "Oui" }, { id: "b", text: "Non" }], correctOptionId: "b", audio: DELF_A1_AUDIO.co5 },
  ...
  { id: "a1s-ce1-q4", sectionId: "comprension-escrita", prompt: "Combien est-on payé pour une soiree ?", difficulty: "easy", points: 1, options: [{ id: "a", text: "35 EUR" }, { id: "b", text: "45 EUR" }, { id: "c", text: "55 EUR" }], correctOptionId: "b" },
  { id: "a1s-ce1-q5", sectionId: "comprension-escrita", prompt: "Si vous etes intéressé par l'annonce, que devez-vous faire ?", difficulty: "easy", points: 2, options: [{ id: "a", text: "Envoyer un email" }, { id: "b", text: "Téléphoner" }, { id: "c", text: "Écrire une lettre" }], correctOptionId: "b" },

  // === CE – EXERCICE 2 (6 pts) – Bibliotheque municipale ===
  { id: "a1s-ce2-q1", sectionId: "comprension-escrita", prompt: "Exercice 2 – Vous lisez le panneau de la bibliothèque municipale :\n\n\"BIENVENUE A LA BIBLIOTHÈQUE MUNICIPALE !\n\n• Au premier étage : les livres pour enfants, les journaux.\n• Au deuxième étage : les livres pour adultes, une salle de travail, une salle internet et la cafétéria.\n\nPour aller a la salle internet à partir de l'escalier, marchez jusqu'a l'accueil, puis tournez à gauche. La salle internet est la deuxième salle après les toilettes, à gauche.\n\nHoraires d'ouverture :\n– du lundi au vendredi : 8 h – 12 h\n– le samedi : 8 h – 19 h\"\n\nLes livres pour enfants sont...", difficulty: "easy", points: 1, options: [{ id: "a", text: "au premier étage, avec les journaux" }, { id: "b", text: "au deuxième étage, à côté des toilettes" }, { id: "c", text: "au deuxième étage, derriere la salle internet" }], correctOptionId: "a" },
  { id: "a1s-ce2-q2", sectionId: "comprension-escrita", prompt: "Dans la bibliothèque, il y a...", difficulty: "easy", points: 1, options: [{ id: "a", text: "une cafétéria" }, { id: "b", text: "une salle de cinema" }, { id: "c", text: "une salle de spectacle" }], correctOptionId: "a" },
  { id: "a1s-ce2-q3", sectionId: "comprension-escrita", prompt: "Ou se trouve la salle internet ?", difficulty: "medium", points: 2, options: [{ id: "a", text: "Au premier étage, à droite de l'accueil" }, { id: "b", text: "Au deuxième étage, à gauche après les toilettes" }, { id: "c", text: "Au deuxième étage, à côté de l'accueil" }], correctOptionId: "b" },
  { id: "a1s-ce2-q4", sectionId: "comprension-escrita", prompt: "A quelle heure la bibliothèque ouvre-t-elle le matin ?", difficulty: "easy", points: 1, options: [{ id: "a", text: "7 h" }, { id: "b", text: "8 h" }, { id: "c", text: "9 h" }], correctOptionId: "b" },
  { id: "a1s-ce2-q5", sectionId: "comprension-escrita", prompt: "Quel jour est-ce que la bibliothèque est ouverte l'après-midi ?", difficulty: "easy", points: 1, options: [{ id: "a", text: "Le lundi" }, { id: "b", text: "Le vendredi" }, { id: "c", text: "Le samedi" }], correctOptionId: "c" },

  // === CE – EXERCICE 3 (6 pts) – Petites annonces ===
  { id: "a1s-ce3-q1", sectionId: "comprension-escrita", prompt: "Exercice 3 – Vous lisez les petites annonces dans le journal :\n\n• \"Sport plus\" cherche un vendeur de chaussures à partir d'octobre.\n• Le restaurant \"Bon appétit\" recherche des serveurs pour l'ete (juin - septembre).\n• Médecin recherche une secretaire pour 3 semaines en août. Tel : 04 44 57 65 00.\n• URGENT ! Jeune homme cherche un professeur de danse pour apprendre la valse avant le mariage, le 30 mai. Tel : 06 89 64 53 20.\n• Le club de football de Briancon recherche un joueur (15-17 ans) du 1er septembre au 30 février. Contacter Michel au 04 92 21 43 28.\n\nQui propose un travail de serveur ?", difficulty: "easy", points: 1, options: [{ id: "a", text: "Sport plus" }, { id: "b", text: "Bon appétit" }, { id: "c", text: "Le medecin" }], correctOptionId: "b" },
  ...
  { id: "a1s-ce4-q4", sectionId: "comprension-escrita", prompt: "Le restaurant propose dans l'article est à côté...", difficulty: "easy", points: 2, options: [{ id: "a", text: "de la Tour Eiffel" }, { id: "b", text: "des Champs-Élysées" }, { id: "c", text: "du musee Carnavalet" }], correctOptionId: "b" },
...
const questionsA2: AssessmentQuestion[] = [
  ...
  makeQuestion(
    "a2-q8",
    "gramatica-vocabulario",
    "Completa: Il faut que vous ___ votre dossier aujourd'hui.",
    [
      ["a", "prepare"],
      ["b", "prepares"],
      ["c", "preparer"],
