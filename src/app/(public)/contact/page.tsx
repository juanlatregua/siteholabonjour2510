...
const faqItems = [
  {
    ...
    a: "Clases por Zoom, objetivos por sesion y apuntes en tu zona de alumno.",
  },
  {
    q: "Que precio tiene?",
    a: "A1-B2: pack 4 clases de 55 min por 150EUR. C1-C2: pack 4 clases de 55 min por 200EUR.",
  },
  {
    q: "Como se paga ahora?",
    a: "Pago seguro con tarjeta a través de Stripe en holabonjour.es/contratar.",
  },
  {
    ...
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-gray-700">A1-B2: pack 4 clases de 55 min por 150EUR</p>
          <p className="text-sm text-gray-700">C1-C2: pack 4 clases de 55 min por 200EUR</p>
