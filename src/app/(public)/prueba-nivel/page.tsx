  ...
  return (
    <div className="bg-slate-50">
      <div className="mx-auto max-w-6xl px-4 py-7 sm:px-6 sm:py-9 lg:px-8">
        <section className="rounded-2xl border border-cyan-200/60 bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#1277c2] p-5 text-white shadow-[0_14px_34px_rgba(15,93,160,0.22)] sm:p-7">
          ...
          {assessments.map((assessment) => (
            ...
            >
              <div className="flex items-center justify-between gap-2">
                <p className="inline-flex rounded-full bg-cyan-100 px-2.5 py-1 text-xs font-semibold uppercase tracking-wide text-[#2563eb]">
              ...
              <Link
                ...
                className="mt-5 inline-flex min-h-11 w-full items-center justify-center rounded-xl bg-[#2563eb] px-4 py-2.5 text-sm font-semibold text-white transition group-hover:bg-[#1d4ed8]"
              >
                Empezar prueba
              </Link>
            </article>
