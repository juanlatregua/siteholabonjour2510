  ...
  return (
    <div className="bg-slate-50">
      <div className="mx-auto max-w-6xl px-4 py-7 sm:px-6 sm:py-9 lg:px-8">
        <section className="rounded-2xl border border-cyan-200/60 bg-gradient-to-br from-[#1e40af] via-[#2563eb] to-[#60a5fa] p-5 text-white shadow-[0_14px_34px_rgba(15,93,160,0.22)] sm:p-7">
